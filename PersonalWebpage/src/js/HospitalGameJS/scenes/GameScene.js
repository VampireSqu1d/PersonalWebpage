class GameScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({
            key: 'tableEnemy',
            frames: this.anims.generateFrameNames('MonsterTable', { start: 0, end: 5}),
            frameRate: 5,
            repeat: -1
        });
        ...
        this.anims.create({
            key: 'heartbeat',
            frames: this.anims.generateFrameNames('Heartbeat',{start: 0, end: 11}),
            frameRate: 12,
            repeat: -1
        });
        ...
        this.anims.create({
           key: 'monitor',
           frames:  this.anims.generateFrameNames('Monitor', {start: 0 , end: 2}),
           frameRate: 3,
           repeat: -1
        });
