class BootScene extends Phaser.Scene {
    ...
    loadSpriteSheets() {
        this.load.spritesheet('characterCar', '../../assets/CarDemo/Character sprites/!$CC_redcar_idle.png', { frameWidth: 120, frameHeight:  113 });
        this.load.spritesheet('characterCarMoving', '../../assets/CarDemo/Character sprites/!$CC_redcar_moving.png', { frameWidth: 120, frameHeight:  113 });
    }
