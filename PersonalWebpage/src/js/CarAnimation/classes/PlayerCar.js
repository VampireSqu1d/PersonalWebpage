    ...
    constructor(scene, x, y, key, frame) {
        ...
        this.anims.create({
            key: 'hover',
            frames: this.anims.generateFrameNames( 'characterCar', { start: 0,  end: 2 }),
            frameRate: fps,
            repeat: -1,
        });
        ...
        this.anims.create({
            key: 'movingRight',
            frames: this.anims.generateFrameNames( 'characterCarMoving', { start: 6,  end: 8 }),
            frameRate: fps,
            repeat: -1,
        });
        ...
        this.anims.create({
            key: 'movingLeft',
            frames: this.anims.generateFrameNames( 'characterCarMoving', { start: 3,  end: 5 }),
            frameRate: fps,
            repeat: -1,
        });
        ...
        this.anims.create({
            key: 'movingUp',
            frames: this.anims.generateFrameNames( 'characterCarMoving', { start: 9,  end: 11 }),
            frameRate: fps,
            repeat: -1,
        });
        ...
        this.anims.create({
            key: 'movingDown',
            frames: this.anims.generateFrameNames( 'characterCarMoving', { start: 0,  end: 2 }),
            frameRate: fps,
            repeat: -1,
        });
